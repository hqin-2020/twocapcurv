...
filename_ell = "./output/"*dataname*"/kappa_"*string(kappa)*"_zeta_"*string(zeta)*"/gamma_"*string(gamma)*"_rho_"*string(rho)*"/"
...
"V0" => V0, "V" => V, "Vr" => Vr, "Vz" => Vz, "val" => val, "gamma" => gamma, "rho" => rho,
"d1" => d1, "d2" => d2,
"h1" => h1, "h2" => h2, "hz" => hz,
"times" => times,
