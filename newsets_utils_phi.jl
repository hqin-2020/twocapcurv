...
function dstar_twocapitals!(d1::Array{Float64,2},
    ...
    for i=1:IJ
        ...
        if rho == 1.0
            ...
            x0 = 0.03;
            d1_root = find_zero(f, x0, Roots.Order1(), maxiters = 100000000000, xatol = 10e-15, xrtol = 10e-15, atol = 10e-18, rtol = 10e-18, strict = true);
...
function value_function_twocapitals(gamma::Float64,
    ...
    #   V0 = npzread("/project/lhansen/twocapbal/output/Standard_grid_sym_Delta_300_scale_1754_tol_21_15_300_frac_0.0/gamma_8.0_rho_1.00001/model_sym_HS.npz")["V"]
      ...
      for n=1:maxit
          ...
          dstar_twocapitals!(d1_F, d2_F, Vr_F, pii, zz, IJ, fraction, rho, V, model);
          dstar_twocapitals!(d1_B, d2_B, Vr_B, pii, zz, IJ, fraction, rho, V, model);
    ...
    return A, v,val, d1_F, d2_F, d1_B, d2_B, h1_F, h2_F, hz_F, h1_B, h2_B, hz_B,
           mu_1_F, mu_1_B, mu_r_F, mu_r_B, mu_z, V0, Vr, Vz, rr, zz, pii, dr, dz;
end
